...
# BİST GÜNCEL HİSSE LİSTESİ (BİST TÜM)
BIST_HISSELER = """
...
def hisse_analiz(ticker):
    ...
    try:
        ...
        # FİLTRE (KATI - Şişmiş malı eler, yeni kalkanı bulur)
        filtre_gecti = (
            adx > 25 and                  # Trend güçlü olmalı (18'den 25'e çıktı)
            mfi > 40 and                  # Para girişi olmalı
            vwap_breakout > 1.5 and       # VWAP üstüne atmış olmalı
            vwap_breakout < 8.0 and       # Ama çok uçmamış olmalı (Max %8)
            mtf_uyumlu and                # Çoklu zaman dilimi onayı
            rsi > 35 and rsi < 70 and     # RSI şişmemiş olmalı
            stoch_k > stoch_d and         # Stoch Al'da olmalı
            stoch_k > 30 and              # Dibi sıyırmış,
            stoch_k < 80 and              # Ama aşırı alıma gelmemiş olmalı (Tepeyi eler)
            risk_odul < 0.7
        )
